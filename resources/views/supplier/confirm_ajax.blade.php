...
@else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            <th class="text-right col-3">Telp. Supplier  :</th>
                            <td class="col-9">{{ $supplier->telp_supplier }}</td>
                        </tr>
                    </table>
                </div>
    ...
    <!-- Bootstrap JS (buat modal) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>

    <!-- SweetAlert2 (buat alert sukses/gagal) -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <!-- jQuery Validation (optional, kalau mau validasi form) -->
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            dataSupplier.ajax.reload(); // HARUS disesuaikan sama nama tabel datatable supplier kamu
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: 'Gagal',
